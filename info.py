...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002566326238 -1003650139062').split()]  # Channel id for auto indexing (make sure bot is admin)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ncadminbot')  # Support group link (make sure bot is admin)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+fEDUfFgXlao4NWJl') # Group link for the bot
